...
function initTable() {
    $table.bootstrapTable('destroy').bootstrapTable({
        ...
        columns: [
            ...
            [{
                field: 'client_info.first_name',
                title: 'First Name',
                sortable: true,
                align: 'center',
                footerFormatter: totalNameFormatter
            }, {
                field: 'client_info.last_name',
                title: 'Last Name',
                sortable: true,
                align: 'center'
            }, {
                ...
                field: 'client_info.phone_number',
                title: 'Phone Number',
                align: 'center'
            }, {
                field: 'client_info.birth_date',
                title: 'Birth Date',
                sortable: true,
                align: 'center'
            }, {
                field: 'client_detail.pay_in',
                title: 'Pay In',
                sortable: true,
                align: 'center',
                footerFormatter: totalSumFormatter
            }, {
                field: 'client_detail.win',
                title: 'Win',
                sortable: true,
                align: 'center',
                footerFormatter: totalSumFormatter
