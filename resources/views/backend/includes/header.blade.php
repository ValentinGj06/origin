<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/logo.png') }}" width="60" height="60" alt="Origin Logo">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/brand/logo.png') }}" width="35" height="35" alt="Origin Logo">
    </a>
